...
- [server/mock_cubi_server.py](server/mock_cubi_server.py)
  Standalone Cubi-compatible HTTP mock
- [server/manager.py](server/manager.py)
...
- [server/playground.py](server/playground.py)
...
- [profiles/returns.json](profiles/returns.json)
- [profiles/repair.json](profiles/repair.json)
- [profiles/wire-heavy.json](profiles/wire-heavy.json)
